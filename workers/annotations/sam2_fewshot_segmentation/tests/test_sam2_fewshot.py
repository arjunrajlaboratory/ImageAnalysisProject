...
class TestInterface:
    ...
    def test_interface_sets_all_fields(self, mock_client_class):
        ...
        with patch('os.listdir', return_value=['sam2.1_hiera_small.pt', 'sam2.1_hiera_large.pt']):
        ...
        assert interface_data['Points per side']['default'] == 32
        assert interface_data['Model']['default'] == 'sam2.1_hiera_small.pt'
