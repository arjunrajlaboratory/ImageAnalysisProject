...
Deconvolves H&E stains

## Interface Parameters

| Parameter | Type | Required | Default | Range / Options | Description |
|-----------|------|:--------:|---------|-----------------|-------------|
| **Max percentile** | `number` |  | 99 | 0 - 100 | Enter the maximum percentile to rescale the image to. |
...
```bash
./build_workers.sh h_and_e_deconvolution
```

## Testing

```bash
./build_workers.sh --build-and-run-tests h_and_e_deconvolution
```
