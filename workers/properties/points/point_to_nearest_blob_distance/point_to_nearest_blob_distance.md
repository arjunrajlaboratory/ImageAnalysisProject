...
|-----------|------|:--------:|---------|-----------------|-------------|
| **Blob tags** | `tags` | Yes | -- | -- |  |
| **Distance type** | `select` |  | Centroid | Centroid, Edge |  |
| **Create connection** | `checkbox` |  | False | -- |  |
...
```bash
./build_workers.sh point_to_nearest_blob_distance
```

## Testing

```bash
./build_workers.sh --build-and-run-tests point_to_nearest_blob_distance
```
